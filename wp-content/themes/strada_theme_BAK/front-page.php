...
<main class="l-main p-top">
  ...
  <div class="t-banner">
    <div class="l-container">
      <img src="<?php echo get_template_directory_uri(); ?>/images/top/img_mv02.jpg" width="740" alt="" />
    </div>
  </div>
  <div class="t-news">
                ...
                while($the_query->have_posts()) : $the_query->the_post(); ?>
                  <li>
                    <a href="<?php echo get_permalink(get_the_ID()); ?>">
                      <time><?php echo get_the_date('Y.j.m') ?></time>
  ...
  <div class="t-about t-block">
    ...
    <div class="t-about_main">
      <div class="l-container">
        ...
        <div class="t-about_video">
          <iframe
            width="100%"
            height="345"
            src="https://www.youtube.com/embed/uJ4AD3AMmmQ"
  ...
  <div class="t-voice t-block">
    ...
    <div class="t-voice_main">
      <a href="#">
        <img src="<?php echo get_template_directory_uri(); ?>/images/top/01.jpg" alt="" />
      </a>
      <a href="#">
        <img src="<?php echo get_template_directory_uri(); ?>/images/top/01.jpg" alt="" />
      </a>
