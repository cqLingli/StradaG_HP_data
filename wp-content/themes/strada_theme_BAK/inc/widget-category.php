...
class Category_Widget extends WP_Widget {
    ...
    */
    public function widget( $args, $instance ) {
        ...
        echo ' <div class="l-commonCategories">';
        // Output widget title
        ...
        ?>
            <ul class="c-list__cat">
                ...
                ?>
                <li><a href="<?php echo get_option('home').'/category/'.$category->slug; ?>"><?php echo $category->cat_name; ?> (<?php echo $category->category_count; ?>)</a></li>
                <?php } ?>
            </ul>
