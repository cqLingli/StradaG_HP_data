  ...
  <div class="block_wrap1">
    ...
    <div id="list_wrap1" class="node_wrap1 node_wrap_show1">
      <div class="Message_style1">
        ...
        <p class="Message_style1_p2">ビジネスの土台作りから<br />拡大・上場まで一括支援。</p><br >
        <p class="Message_style1_p3">　「ストラーダ」とは、イタリア語で「道」という意味があります。<br /><br />　お客様と歩む長い道をともに歩み続けられるような、会社にしたいという意味を込めて、
「ストラーダビジネスサポート」と名付けました。<br />　私たちの使命は、バックオフィスの総合的な支援です。<br /><br /></p>
  ...
  <div id="Service" class="block_wrap3">
    ...
    <?php get_template_part('archive', 'sb-service'); ?>
    </div>
    </div>
  </div>
  <!-- end Service -->
