...
<!--          <p class="Youtube_text">中小企業労働企画開発協会紹介動画 Youtube</p>-->
<!--        </div>-->
...
労働保険事務組合とは、 事業主の委託を受けて、事業主が行うべき労働保険の事務を処理することについて、厚生労働大臣の認可を受けた中小事業主等の団体です。<br><br>
事業主は労災保険の適用が除外されておりますが、労働保険事務組合に労働保険の事務を委託することで、労災保険に特別に加入することが可能です。<br><br>
労災保険では、労働者が業務中又は通勤中に負傷や疾病等で病院を受診する際や一定期間給与（報酬）を受けれなくなった際に、必要な保険給付を迅速に行う制度であり、手厚い給付を受けることが可能です。<br><br><br>
          </p>
...
<!--    </div>-->
  ...
  <div class="block_wrap3">
    ...
    <div id="list_wrap3" class="node_wrap3 node_wrap_show3">
      <?php get_template_part('template', 'ch-service'); ?>
    </div>
  </div>
  <!-- end Service -->
    ...
    <div class="border-bt">
      <div class="l-container">
        <div style="display:flex">
          ...
          <div id="text4" class="border-text border-text-controll">Benefits of Joining</div>
        </div>
      </div>
    </div>
      ...
      <div class="l-container">
        <div style="display:flex">
          <div id="block_wrap6" class="title_item_wrap6 active6">
            <p class="chapter_title6">Membership
            <div class="circle6"></div>
            </p>
          </div>
          <div id="text6" class="border-text border-text-controll">ご入会案内</div>
        </div>
      </div>
    </div>
  ...
  <div class="block_wrap8">
    ...
    <div id="list_wrap8" class="node_wrap8 node_wrap_show8">
      <?php get_template_part('template', 'contact_ch'); ?>
    </div>
  </div>
  <!-- end Contact -->
