...
-->
  <div class="l-container">
    ...
    <div class="company_infomation">
      <p>
        ストラーダグループでは、各分野のプロフェッショナルが集結し、お客様のあらゆる経営課題解決のために現場主義を貫いた経営支援を行っています。<br />
        中でもストラーダ行政書士法人では、ビザ申請・建設業許可申請・会社設立申請などの行政申請作業を、幅広く個人・法人のお客様に対してサービスを提供しております。
      </p>
    </div>
  </div>
        ...
        <div class="recruit-container">
          <div class="t-recruitContent" id="募集要項">
            <div class="t-recruitContent__list">
              ...
              <dl>
                <dt>業務内容</dt>
                <dd>ビザ申請・建設業許可申請・会社設立申請などの行政申請作業
                </dd>
              </dl>
              <dl>
                <dt>勤務形態</dt>
              ...
              <dl>
                <dt>勤務時間</dt>
                <dd>月曜日～金曜日　9:00~18:00　土曜日・日曜日祝日休み<br />
                  有給休暇あり<br />
                  夏季・冬季休暇あり</dd>
              </dl>
              <dl>
