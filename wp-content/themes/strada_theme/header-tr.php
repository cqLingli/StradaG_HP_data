...
<!--
  ...
  -->
            ...
            <div class="h-mail h-mail--4">
              <a href="#" target="_blank">
                <img style="width: 50px;height: auto;"src="<?php echo get_template_directory_uri(); ?>/images/common_tr/seach_icon.png" alt="" />
              </a>
            </div>
    ...
    <div class="l-header__nav">
      <div class="l-container">
        <ul class="h-nav">
          ...
          <li>
            <a href="<?php echo get_permalink(134); ?>"><div class="vertical-line">お客様の声</div></a>
          </li>
          <li>
            <a href="<?php echo get_permalink(42); ?>"><div class="vertical-line">会社概要</div></a>
          </li>
          <li>
            <a href="<?php echo get_post_type_archive_link('news'); ?>"><div class="vertical-line">メンバー紹介</div></a>
          </li>
          <li>
