...
<main class="l-main p-top">
  ...
  <div class="imageplay">
    ...
    <ul>
      ...
      <li>
        <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/top_TR/Strada_Group_Slider_01.png"
            alt="" /></a>
      </li>
      <li>
        <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/top_TR/Strada_Group_Slider_01.png"
      ...
      <div id="list_wrap" class="node_wrap node_wrap_show">
        ...
        <div class="news_style2">
          <div class="t-news_list_topbox">
            <a href="<?php echo home_url('tr/taxrianewslist'); ?>" style="text-decoration:none">
  ...
  <div class="block_wrap1">
    ...
    <div id="list_wrap1" class="node_wrap1 node_wrap_show1">
      <div class="Message_style1">
        ...
        <p class="Message_style1_p3">　株式会社タックス・リアルティは、不動産会社として2021年に誕生いたしました。<br />　弊社の株主にはストラーダグループの資本が入っており、そのため、弊社の特徴としましては、士業の専門家チームと提携し、より多角的にお客様のサポートをすることが可能です。<br />　不動産含め資産と税金とは紐づくものであり、この資産と税金を総合的にコンサルタントすることで、一時的なサービスではなく、お客様と共に長い道を歩み続けられるような不動産会社にしたいという思いを込めております。<br />　そのため、私達は目先の利益に囚われずに、未来に繋がるアドバイスをさせて頂きます。<br /></p>
  ...
  <div class="block_wrap3">
    ...
    <?php get_template_part('archive', 'tr-service'); ?>
    </div>
    </div>
  </div>
  <!-- end Service -->
  ...
  <div style="display:flex">
    <div id="block_wrap5" class="title_item_wrap5 active5">
      ...
      <div class="border-text5">よくある質問</div>
    </div>
  ...
  <div style="display:flex">
    <div id="block_wrap6" class="title_item_wrap6 active6">
      ...
      <div class="border-text6">お客様からの声</div>
    </div>
