<div class="t-price">
    <div class="l-container">
        ...
        <p class="price_note">
        当行政書士法人の報酬額一覧です。<br>
        ※下記は報酬額の目安です。詳細については、各々の難易度等ご依頼いただく内容により異なりますので、個別見積をご請求の上ご確認ください。<br>
        ※下記の報酬額には、通信費・交通費等の実費は含まれておりません。
    </p>
    </div>
            ...
            <div class="p-entry__body body1">
                <div class="l-container">
                    <div class="price_style">
                        <div class="price_head">当行政書士法人の報酬額</div>
                        <h3 class="left_heading">法人設立（居住者）</h3>
                        ...
                        <h3 class="left_heading">法人設立（非居住者が代表・株主）</h3>
                        <figure class="wp-block-table is-style-stripes">
                            <table>
                            <tr>
                                    <td class="has-text-align-center5">内容</td>
                        ...
                        <h3 class="left_heading">建設業許可申請</h3>
                        <figure class="wp-block-table is-style-stripes">
                            <table>
                            <tr>
                                    <td class="has-text-align-center5">内容</td>
                                    <td class="has-text-align-center5">料金（税抜）</td>
                                </tr>
                                <tr>
                        ...
                        <h3 class="left_heading">宅建業免許申請</h3>
                        <figure class="wp-block-table is-style-stripes">
                            <table>
                            <tr>
                                    <td class="has-text-align-center5">内容</td>
                            ...
                            <p class="price_note1">
                            <strong>法人設立サービスと同時申し込みの場合</strong><br>
                            ①法人設立から免許取得までに、実費含めて<strong>200万円程度</strong>必要です。<br>
                            ②法人設立用ヒアリングシート提出から宅建業の営業開始まで、<strong>3.5~4か月</strong>必要です。
    </p>
                        </figure>

                        <h3 class="left_heading">その他許可申請</h3>
                        <figure class="wp-block-table is-style-stripes">
                            <table>
                            <tr>
                                    <td class="has-text-align-center5">内容</td>
                        ...
                        <h3 class="left_heading">ビザ申請サービス</h3>
                        <figure class="wp-block-table is-style-stripes">
                            <table>
                            <tr>
                                    <td class="has-text-align-center5">内容</td>
                                ...
                                <tr>
                                    ...
                                    <td class="has-text-align-center4">80,000円～</td>
                                </tr>
                            </table>
                        </figure>

                        <h3 class="left_heading">相続手続き</h3>
                        <figure class="wp-block-table is-style-stripes">
                            <table>
                            <tr>
                                    <td class="has-text-align-center5">内容</td>
