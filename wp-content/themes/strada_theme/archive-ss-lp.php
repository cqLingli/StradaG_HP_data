...
<div id="page_content"  class="smooth-scroll page_content" data-scroll-container >
    ...
    <section id="top__mv" class="top__mv section__full__height" data-scroll-section data-scroll-section-id="section0">
        ...
        <div class="top__mv__wrap">
            <div class="top__mv__image" style="opacity: 1;width: 100%">
                <img style="translate: none;scale: none;opacity: 1;"
                     src="<?php echo home_url('wp-content/uploads/2023/09/mv-01.jpg')?>" alt="ストラーダ社会保険労務士法人" class="top__mv__image__item">
            </div>
        </div>
            ...
            <h2 class="top__mv__caption" style="font-size: 3.2rem!important;">
                    <span class="caption__text__wrap" style="opacity: 1">
                        <span class="caption__text caption-01">
                            <span class="caption__text__inner" style="translate: none;rotate: none; scale: none;transform: translate(0px, 0px);">あなたは、</span>
                        </span>
                    </span>
                <span class="caption__text__wrap"  style="opacity: 1">
                        <span class="caption__text caption-02">
                            <span class="caption__text__inner" style="translate: none;rotate: none; scale: none;transform: translate(0px, 0px);">障害年金をもらえる</span>
                        </span>
                    </span>
                <span class="caption__text__wrap" style="opacity: 1">
                        <span class="caption__text caption-03">
                            <span class="caption__text__inner" style="translate: none;rotate: none; scale: none;transform: translate(0px, 0px);">かもしれません</span>
                        </span>
                    </span>
            </h2>
        </div>
        ...
        <div class="top__mv__note">
            <div class="top__mv__note__image mv__note__image-01">
                <img style="width: 150px;" src="<?php echo home_url('wp-content/uploads/2023/09/p-01.svg')?>" alt="ストラーダ社会保険労務士法人" class="top__mv__note__image">
            </div>

            <div class="top__mv__note__image mv__note__image-02">
                <img style="width: 150px;" src="<?php echo home_url('wp-content/uploads/2023/09/p-02.svg')?>" alt="ストラーダ社会保険労務士法人" class="top__mv__note__image">
            </div>

            <div class="top__mv__note__image mv__note__image-03">
                <img style="width: 150px;" src="<?php echo home_url('wp-content/uploads/2023/09/p-03.svg')?>" alt="ストラーダ社会保険労務士法人" class="top__mv__note__image">
            </div>
        </div>
    ...
    <!-- CONTACT SECTION-->
    <section id="contact__section" class="section__wrapper" data-scroll-section data-scroll-section-id="section1" data-scroll-section-inview>
            ...
            <div class="row">
                    ...
                    <div class="contact__wrap contact__phone">
                        ...
                        <div class="contact__wrap__bkg">
                            <div class="contact__wrap__bkg__image">
                                <img src="<?php echo home_url('wp-content/uploads/2023/09/phone.webp')?>" alt="" class="bkg__image__item">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 d-flex p-0">
                    <div class="contact__wrap contact__mail">
                        ...
                        <div class="contact__wrap__bkg">
                            <div class="contact__wrap__bkg__image">
                                <img src="<?php echo home_url('wp-content/uploads/2023/09/mail.webp')?>" alt="" class="bkg__image__item">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <a href="https://works.do/R/ti/p/sr@strada-group" class="contact__link">
                            <div class="contact__content">
                                <div class="contact__line__img">
                                    <img src="<?php echo home_url('wp-content/uploads/2023/09/line-qr.jpg')?>" alt="" class="contact__line__img__item">
                                </div>
                            </div>
                        </a>
                        <div class="contact__wrap__bkg">
                            <div class="contact__wrap__bkg__image">
                                <img src="<?php echo home_url('wp-content/uploads/2023/09/line.jpg')?>" alt="" class="bkg__image__item">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="d-flex justify-content-center align-items-center">
                <h2 class="section__note__title">
                    <span class="section__note__text"><span class="section__note__text__item">こんなお悩みありませんか？</span></span>
                </h2>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="bordred-box bordred-box__negative px-2 px-md-7 py-5 py-md-9 mb-5 mb-md-7" data-scroll data-scroll-speed="2">
    ...
    <section class="section__wrapper section__bkg__light" data-scroll-section data-scroll-section-id="section3">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-7 d-flex align-items-center justify-content-center" data-scroll data-scroll-speed="2">
                    ...
                    <div class="d-block">
                        ...
                        <h3 class="section__note__title__sub">
                            <span class="section__note__text"><span class="section__note__text__item">こんな方をサポートいたします。</span></span>
                        </h3>
                ...
                <div class="col-lg-5 d-flex align-items-center justify-content-center">
                    <div class="circle__img__wrap">
                        <img src="<?php echo home_url('wp-content/uploads/2023/09/img-11.jpg')?>" alt="" class="circle__img__item">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-5 d-flex align-items-center justify-content-center mb-5 mb-md-7">
                    <div class="rounded__img__wrap">
                        <img src="<?php echo home_url('wp-content/uploads/2023/09/img-03.jpeg')?>" alt="" class="rounded__img__item">
                    </div>
                </div>

                <div class="col-lg-7 d-flex align-items-center justify-content-center" data-scroll data-scroll-speed="1">

                    <div class="d-block">
                        <h3 class="section__note__title__sub">
                            <span class="section__note__text"><span class="section__note__text__item">ストラーダ社労士法人にお任せください。</span></span>
                        </h3>

                        <div class="mb-5">
                            <p>ストラーダ社会保険労務士の宿谷です。私は元医療法人勤務の経験があるため、障害を抱える方のご苦労も身近でみてきております。中には障害年金を受給できるとご存じない方もいらっしゃるため、まずは受給可能かどうかご確認いただきたいと思います。障害年金を受給することで、少しでも皆様の生活のご負担を少なくすることができれば幸いです。ストラーダ社労士法人では、年金障害の申請経験が豊富なスタッフが対応いたしますのでまずはお気軽にご相談ください。</p>
                        </div>
                ...
                <div class="tab__wrap">
                    ...
                    <div class="nav nav-tabs tab__btn__wrap" role="tablist">
                        <div class="nav-item tab__btn" role="presentation">
                            <a href="" class="tab__link active" id="tab-01" data-bs-toggle="tab" data-bs-target="#tab-01-pane" role="tab" aria-controls="tab-01-pane" aria-selected="true">
                                <span>障害基礎年金</span>
                            </a>
                        </div>
                        <div class="nav-item tab__btn" role="presentation">
                            <a href="" class="tab__link" id="tab-02" data-bs-toggle="tab" data-bs-target="#tab-02-pane" role="tab" aria-controls="tab-02-pane" aria-selected="false">
                                <span>障害厚生年金</span>
                            </a>
                        </div>
                    </div>
                ...
                <div class="tab-content px-2 px-md-7 py-5 py-md-9">
                    ...
                    <div class="tab-pane fade" id="tab-02-pane" role="tabpanel" aria-labelledby="tab-02" tabindex="0">
                        ...
                        <ul class="check__list mb-7">
                            ...
                            <li class="check__list__item">
                                <p class="check__list__text check__list__text__big">両手のすべての指を欠く状態又はすべての指その機能に著しい障害を有する状態等</p>
                            </li>
                        </ul>
                        <h3 class="mini__title">
                        ...
                        <ul class="check__list mb-7">
                            <li class="check__list__item">
                                <p class="check__list__text check__list__text__big">人工透析治療を行っている状態精神疾患により、日常生活に著しい制限を受ける状態</p>
                            </li>
                        </ul>
                        ...
                        <ul class="check__list mb-7">
                            <li class="check__list__item">
                                <p class="check__list__text check__list__text__big">人工関節の挿入やストーマ（人工肛門や人工膀胱）の手術をしたペースメーカーを植え込んだ</p>
                            </li>
                        </ul>
                    ...
                    <div class="card__wrap">
                        <div class="card_content">
                            ...
                            <div class="card__image">
                                <img src="<?php echo home_url('wp-content/uploads/2023/09/img-04.jpg')?>" alt="" class="card__image__item">
                            </div>
                ...
                <div class="col-md-4 mb-5 mb-md-7" data-scroll data-scroll-speed="1">
                    <div class="card__wrap">
                        <div class="card_content">
                            ...
                            <div class="card__image">
                                <img src="<?php echo home_url('wp-content/uploads/2023/09/img-05.jpg')?>" alt="" class="card__image__item">
                            </div>
                            <div class="card__text__wrap">
                ...
                <div class="col-md-4 mb-5 mb-md-7" data-scroll data-scroll-speed="2">
                    <div class="card__wrap">
                        <div class="card_content">
                            ...
                            <div class="card__image">
                                <img src="<?php echo home_url('wp-content/uploads/2023/09/img-06.jpg')?>" alt="" class="card__image__item">
                            </div>
                            <div class="card__text__wrap">
        ...
        <div class="container">
            ...
            <div class="step__block">
                ...
                <div class="bordred-box px-2 px-md-7 py-5 py-md-9">
                    ...
                    <p>お気軽にお問い合わせください。その際、障害年金を受給できるかどうかのおおよその判断やスムーズなお手続きのために、 お名前や傷病名、現在の症状や年金加入期間、初診日などをお聞きします。</p>
                </div>
            ...
            <div class="step__block">
                ...
                <div class="bordred-box px-2 px-md-7 py-5 py-md-9">
                    ...
                    <div class="mb-9">
                        ...
                        <p>2お気軽にお問い合わせください。その際、障害年金を受給できるかどうかのおおよその判断やスムーズなお手続きのために、 お名前や傷病名、現在の症状や年金加入期間、初診日などをお聞きします。</p>
                    </div>
                    ...
                    <div class="mb-9">
                        ...
                        <p>初診日や保険料納付要件などを確認し、申請書を作成します。 初診日の特定は、障害年金の請求手続きをする上でとても重要な項目です。 この初診日を基に「保険料納付要件」や「障害認定日要件」が判定されます。 また受給する年金の種類や、金額にも影響してきます。 また、年金保険料を一定期間納めていなければ障害年金の請求は出来ません。 納付要件は初診日の前日時点となります。</p>
                    </div>
    ...
    <section class="section__wrapper section__bkg__light" data-scroll-section data-scroll-section-id="sectio10">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-7 d-flex align-items-center justify-content-center">
                    ...
                    <div class="d-block">
                        ...
                        <div class="mb-7" data-scroll data-scroll-speed="2">
                            <p>過去に障害年金が不支給になっていても再請求が可能です。 障害年金は、請求書の書き方一つで不支給となったり、もらえる受給額が大きく変わったりするケースが多くあります。そこで、私たち専門家にご相談いただければ、障害年金についてのアドバイスも行わせていただきます。是非一度、ご相談ください。</p>
                        </div>
                ...
                <div class="col-lg-5 d-flex align-items-center justify-content-center">
                    <div class="circle__img__wrap">
                        <img src="<?php echo home_url('wp-content/uploads/2023/09/img-07.jpg')?>" alt="" class="circle__img__item">
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <ul class="check__list">
                <li class="check__list__item">
                    ...
                    <p>※ご契約書を締結時に電子決済でお支払いをいただいております。 <span class="d-block">対応クレジットカード：<span class="text-orange">JCB, MasterCard, VISA, AMERICAN EXPRESS, Diners Club INTERNATIONAL</span></span></p>
                </li>
                <li class="check__list__item">
            ...
            <div id="faq__section" class="accordion faq__wrap">
                ...
                <div onclick="btn('faq-02')" id="div-faq-02" class="faq__item px-4 px-md-5 py-4 py-md-5 mb-3 mb-md-5" data-bs-toggle="collapse" data-bs-target="#faq-02" aria-expanded="false" aria-controls="faq-02">
                    ...
                    <div id="faq-02" class="a__accordion collapse" data-bs-parent="#faq__section">
                        <div class="a__accordion__inner">
                            <p class="faq__text mb-0">初診日の前日に、初診日がある月の前々月までの被保険者期間で、国民年金の保険料納付済期間（厚生年金保険の被保険者期間、共済組合の組合員期間を含む）と保険料免除期間をあわせた期間が3分の2以上あること。</p>
                            <p class="faq__text mb-0">ただし、初診日が令和8年4月1日前にあるときは、初診日において65歳未満であれば、初診日の前日において、初診日がある月の前々月までの直近1年間に保険料の未納がなければよいことになっています。</p>
                            <p class="faq__text mb-0">また、20歳前の年金制度に加入していない期間に初診日がある場合は、納付要件は不要です。詳しくはご相談の上、要件を満たしているか判断させていただきます。</p>
                        </div>
                    </div>
                </div>
                ...
                <div onclick="btn('faq-03')" id="div-faq-03" class="faq__item px-4 px-md-5 py-4 py-md-5 mb-3 mb-md-5" data-bs-toggle="collapse" data-bs-target="#faq-03" aria-expanded="false" aria-controls="faq-03">
                    ...
                    <div id="faq-03" class="a__accordion collapse" data-bs-parent="#faq__section">
                        <div class="a__accordion__inner">
                            <p class="faq__text mb-0">長期との闘病が続くと最初の病院がどこなのかわからなくなります。弊社ではお客様の話をじっくり伺い、どこなのか一緒に特定していきます。</p>
                        </div>
                    </div>
                </div>
