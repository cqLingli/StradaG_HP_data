...
-->
  <div class="l-container">
    ...
    <div class="company_infomation">
      <p>
        ストラーダビジネスサポート株式会社には各分野のプロフェッショナルが集結し、お客様のあらゆる経営課題解決のために現場主義を貫いた経営支援を行っています。国内でのバリュエーション、M&A、補助金申請代行など、会計系の高い専門性を持ったサービスだけでなく、会計コンサルティングの枠を超えたサービスをも提供しています。
      </p>
    </div>
  </div>
      ...
      <div class="recruit-contain_style">
        <div class="recruit-container">
          ...
          <div class="p-recruitBtn">
            <a href="https://strada-sb.jp/recruit/form">
