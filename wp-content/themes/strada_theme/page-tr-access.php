            ...
            <div class="access-list">
                <div class="access">
                    ...
                    <ul>
                        ...
                        <li>
                            <div class="thumb">
                                <img src="<?php echo get_template_directory_uri(); ?>/images/access/access1_03.png" alt="左手に見える青色・緑色・橙色の看板がある建物の６階。備長炭焼一久の向かい。" />
                            </div>
                            <p>左手に見える青色・緑色・橙色の看板がある建物の６階。備長炭焼一久の向かい。</p>
                        </li>
                    </ul>
                </div>
                <div class="access">
                <a id="access02" class="target-fix"></a>
                    ...
                    <ul>
                        ...
                        <li>
                            <div class="thumb">
                                <img src="<?php echo get_template_directory_uri(); ?>/images/access/access2_04.png" alt="右手に日高屋がある角を右折し、110m直進。左手に青色・緑色・橙色の看板がある建物の６階。備長炭焼一久の向かい。" />
                            </div>
                            <p>右手に日高屋がある角を右折し、110m直進。<br/>左手に青色・緑色・橙色の看板がある建物の６階。備長炭焼一久の向かい。</p>
                        </li>
                    </ul>
                </div>
                <div class="access">
                <a id="access03" class="target-fix"></a>
                    ...
                    <ul>
                        ...
                        <li>
                            <div class="thumb">
                                <img src="<?php echo get_template_directory_uri(); ?>/images/access/access1_03.png" alt="日高屋がある角を左折し、110m直進。左手に見える青色・緑色・橙色の看板がある建物の６階。備長炭焼一久の向かい。" />
                            </div>
                            <p>日高屋がある角を左折し、110m直進。<br/>左手に見える青色・緑色・橙色の看板がある建物の６階。備長炭焼一久の向かい。</p>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="access google-map">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3240.7327941343083!2d139.7840313756561!3d35.68358087258646!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x60188984dfabd449%3A0xacb096fd53135487!2z5qCq5byP5Lya56S-44K_44OD44Kv44K544O744Oq44Ki44Or44OG44Kj!5e0!3m2!1sja!2sjp!4v1714269204879!5m2!1sja!2sjp" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
            </div>
        </div>
        </div>
    </div>
