...
<head>
  ...
  <!-- ファビコンの読み込み -->
  <link rel="icon" href="<?php echo home_url(); ?>/favicon-sb.ico" />
        ...
        <div class="l-header__main">
          ...
          <div class="h-info">
            ...
            <div class="h-mail h-mail--1">
              <a href="<?php echo home_url('bs/#Contact'); ?>">
  ...
  -->
    ...
    <div class="l-header__nav">
      <div class="l-container">
        <ul class="h-nav">
          <li><a href="<?php echo home_url('bs/bsnewslist'); ?>"><div class="vertical-line_head">ニュース</div></a></li>
          <li>
          ...
          <li>
            <a href="<?php echo home_url('bs/#About'); ?>"><div class="vertical-line">事務所概要</div></a>
          </li>
          <li>
          ...
          <li>
            <a href="<?php echo home_url('bs/#Recruit'); ?>"><div class="vertical-line">リクルート</div></a>
          </li>            
        </ul>
      </div>
    ...
    <div id="search_content_ID" class="search_content">
      ...
      <a href="<?php echo home_url('bs/bsnewslist'); ?>"><div class="search_content_style">ニュース</div></a>
      <a href="<?php echo home_url('bs/bsservicelist'); ?>"><div class="search_content_style">業務内容</div></a>
      <a href="<?php echo home_url('bs/bscasestudylist'); ?>"><div class="search_content_style">事例</div></a>
      <a href="<?php echo home_url('bs/#About'); ?>"><div class="search_content_style">事務所概要</div></a>
      <a href="<?php echo home_url('bs/bsmenber'); ?>"><div class="search_content_style">メンバー紹介</div></a>
      <a href="<?php echo home_url('bs/bsaccess'); ?>"><div class="search_content_style">アクセス</div></a>
      <a href="<?php echo home_url('bs/#Recruit'); ?>"><div class="search_content_style">リクルート</div></a>
      </div>
