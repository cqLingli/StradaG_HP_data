...
<!--
  ...
  -->
    ...
    <div class="l-header__nav">
      <div class="l-container">
        <ul class="h-nav">
          <li><a href="<?php echo home_url('chushoukigyouroudou/chushoukigyouroudounewslist'); ?>"><div class="vertical-line_head">ニュース</div></a></li>
          <li>
          ...
          <li>
            <a href="<?php echo home_url('chushoukigyouroudou/#About'); ?>"><div class="vertical-line">事務所概要</div></a>
          </li>
          <li>
  ...
  <?php set_query_var('headername', "ch"); ?>
  </header>