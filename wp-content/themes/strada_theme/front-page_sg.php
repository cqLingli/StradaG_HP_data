...
<main class="l-main p-top">
  ...
  <div class="imageplay">
    ...
    <ul>
      <li>
        <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/top_SG/G_HP_Top_Image.png"
            alt="" /></a>
      </li>
      <li>
        <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/top_SG/G_HP_Top_Image.png"
    ...
    <div id="list_wrap" class="node_wrap node_wrap_show">
      ...
      <a href="<?php echo home_url('admin/adminnewslist'); ?>" style="text-decoration:none">
              <div style="display: flex;overflow-x: hidden;width:100%">
                <div style="width:95%;color:#808C96;font-weight:bold;">ニュース</div>
                <div>
...
とに挑戦し続ける事務所経営を行います。<br /><br /></p>
      ...
      <div class="Message_style2">
        <img src="<?php echo get_template_directory_uri(); ?>/images/top_SG/SZ_member_04_Hoshino.jpg" alt=""
