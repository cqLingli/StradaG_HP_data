      ...
      <div class="t-access_content">
        ...
        <ul>
          <li>
            ...
            <a href="<?php echo (is_page('access') ? '#access01' : (home_url('access').'#access01')) ?>">
              経路はこちら
              <svg xmlns="http://www.w3.org/2000/svg" width="9.512" height="18.265" viewBox="0 0 9.512 18.265">
                <path id="Path_4364" data-name="Path 4364"
                  d="M11.434-13.058,4.769-6.292l.8,2.342,8.7-9.132-8.7-9.132L4.756-19.9Z"
                  transform="translate(-4.756 22.214)" />
              </svg>
            </a>
          </li>
          <li>
            <span>日比谷線：人形町駅 A2出口から徒歩5分 </span>
            <a href="<?php echo (is_page('access') ? '#access02' : (home_url('access').'#access02')) ?>">
              経路はこちら
              <svg xmlns="http://www.w3.org/2000/svg" width="9.512" height="18.265" viewBox="0 0 9.512 18.265">
                <path id="Path_4364" data-name="Path 4364"
                  d="M11.434-13.058,4.769-6.292l.8,2.342,8.7-9.132-8.7-9.132L4.756-19.9Z"
          ...
          <li>
            ...
            <a href="<?php echo (is_page('access') ? '#access03' : (home_url('access').'#access03')) ?>">
              経路はこちら
              <svg xmlns="http://www.w3.org/2000/svg" width="9.512" height="18.265" viewBox="0 0 9.512 18.265">
                <path id="Path_4364" data-name="Path 4364"
                  d="M11.434-13.058,4.769-6.292l.8,2.342,8.7-9.132-8.7-9.132L4.756-19.9Z"
