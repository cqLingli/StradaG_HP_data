...
<p>
	...
	<label><input type="checkbox" name="edit_views" value="1" /><?php _e( '閲覧数を編集する', 'sp-tpl' ); ?></label>
</p>
<script>
jQuery(function($){
	...
	<div class="inline-edit-col column-views">
		<div class="inline-edit-group">
			<label class="inline-edit-views" style="float:left;margin-right:1em;">
				<span class="title"><?php _e( 'Views', 'sp-tpl' ); ?></span>
			...
			<label class="inline-edit-views" style="padding-top:0.2em;">
				<input type="checkbox" name="edit_views" value="1" /> <?php _e( '閲覧数を編集する', 'sp-tpl' ); ?>
			</label>
		</div>
	</div>
</fieldset>
...
add_action( 'topic_row_actions', 'views_custom_quick_edit_values', 100, 2 );
...
function views_admin_colmun_init() {
	...
	add_filter( 'manage_column_posts_columns', 'cf_views_posts_columns', 20 );
	...
	add_action( 'manage_topic_custom_column', 'cf_views_posts_custom_column', 20, 2 );
	...
	add_filter( 'manage_edit-topic_sortable_columns', 'cf_views_sortable_columns', 20 );
